		...
		<div class="row">
			<div class="col-lg-12">
				<div class="section_title">
					...
					<p>Please complete the following information to better enjoy your intelligent home system&nbsp;</p>
				</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form_group">
									...
									Name
									<input type="text" class="form_control" name="userNamee"  value = <%= usernamee %>   required>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form_group">
									...
									Gender
									<input type="text" class="form_control"  name="userGender" value= <%= userGender %>  required>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form_group">
							...
							<div class="col-lg-6">
								<div class="form_group">
									...
									<input type="text" class="form_control"  name="userPhone" value=<%= userPhone %> required>
								</div>
							</div>
