...
<html lang="en">
	...
	<body>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="breadcrumb_content">
							<h1>WRONG!</h1>
							<ul>
							   <li>There may be an error in the password you entered.</li>
								<li><a href="show.jsp">Click here to go back. </a></li>
		...
		</section><!-- End deneb_breadcrumb section -->z
				<!-- Start deneb_cta -->
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="copyright_text">
								<p>Copyright &copy; 2019-2020 <span>Deneb</span>. All rights reserved.</p>
							</div>
						</div>
					</div>
				</div>
