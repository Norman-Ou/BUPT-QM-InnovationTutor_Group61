...
public class Admin extends JFrame {
	...
	public Admin() throws ClassNotFoundException,SQLException{
		try {
			...
			conn = DriverManager.getConnection(URL, CLIENT, PSW);
			...
			public void actionPerformed(ActionEvent e) {
				if(!mnametext.getText().equals("")) {
					try {
						...
						ResultSet myRs = myStmt.executeQuery("select * from member where membername like '%"+mnametext.getText()+"%'");
						while (myRs.next()) {
			...
			public void actionPerformed(ActionEvent e) {
				if(!mIDtext.getText().equals("")) {
					try {
						model1.setRowCount(0);
						Statement myStmt = conn.createStatement();
						ResultSet myRs = myStmt.executeQuery("select * from member where memberID = '"+mIDtext.getText()+"'");
						while (myRs.next()) {
							model1.addRow(new String[]{myRs.getString("memberID"),myRs.getString("memberName"),myRs.getString("memberGender"),myRs.getString("memberPhone"),myRs.getString("homeID")});
						}
					}
			...
			public void actionPerformed(ActionEvent e) {
				if(!hnametext.getText().equals("")) {
					try {
						...
						Statement myStmt = conn.createStatement();
						ResultSet myRs = myStmt.executeQuery("select * from home where homename like '%"+hnametext.getText()+"%'");
						while (myRs.next()) {
			...
			public void actionPerformed(ActionEvent e) {
				if(!hIDtext.getText().equals("")) {
					try {
						model2.setRowCount(0);
						Statement myStmt = conn.createStatement();
						ResultSet myRs = myStmt.executeQuery("select * from home where homeID = '"+hIDtext.getText()+"'");
						while (myRs.next()) {
							model2.addRow(new String[]{myRs.getString("homeID"),myRs.getString("homeName"),myRs.getString("homeAddress")});
						}
					}
		...
		hadd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if(hID.getText().equals("")||hname.getText().equals("")||haddress.getText().equals("")) {
						...
						if(myRs.next()) {
							...
							String up = "insert into home values('"+hID.getText()+"','"+hname.getText()+"','"+haddress.getText()+"','0')";
							myStmt.executeUpdate(up);
		...
		result1.setBounds(10, 75, 535, 15);
		hAdd.add(result1);
		...
		search7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Statement myStmt = conn.createStatement();
					ResultSet myRs = myStmt.executeQuery("select * from equipment where equipmentname like '%"+enametext.getText()+"%'");
					while (myRs.next()) {
						model3.addRow(new String[]{myRs.getString("equipmentID"),myRs.getString("equipmentName"),myRs.getString("equipmentManual"),myRs.getString("compID"),myRs.getString("typeID")});
					}
				}
				catch (SQLException se) {
					System.out.println("SQLException:" + se.getMessage());
			...
			public void actionPerformed(ActionEvent e) {
				if(!eIDtext.getText().equals("")) {
					try {
						model3.setRowCount(0);
						Statement myStmt = conn.createStatement();
						ResultSet myRs = myStmt.executeQuery("select * from equipment where equipmentID = '"+eIDtext.getText()+"'");
						while (myRs.next()) {
							model3.addRow(new String[]{myRs.getString("equipmentID"),myRs.getString("equipmentName"),myRs.getString("equipmentManual"),myRs.getString("compID"),myRs.getString("typeID")});
						}
					}
		...
		JLabel lblNewLabel_32 = new JLabel("ID");
		lblNewLabel_32.setBounds(10, 35, 54, 15);
		eAdd.add(lblNewLabel_32);
		...
		textField_7.setBounds(74, 32, 79, 21);
		eAdd.add(textField_7);
		textField_7.setColumns(10);
		
		JLabel lblNewLabel_34 = new JLabel("CompID");
		lblNewLabel_34.setBounds(228, 35, 54, 15);
		eAdd.add(lblNewLabel_34);
		
		textField_9 = new JTextField();
		textField_9.setBounds(292, 32, 87, 21);
		...
		eadd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if(textField_1.getText().equals("")||textField_2.getText().equals("")||textField_7.getText().equals("")||textField_9.getText().equals("")||textField_1.getText().equals("")) {
						...
						Statement myStmt = conn.createStatement();
						ResultSet myRs = myStmt.executeQuery("select * from equipment where equipmentID = '"+textField_7.getText()+"'");
						if(myRs.next()) {
							result2.setText("ID already exists!");
							result2.setVisible(true);
						}
						else {
							...
							if(!myRs.next()) {
								...
								if(!myRs.next()) {
									...
									String up = "insert into equipment values('"+textField_7.getText()+"','"+textField_1.getText()+"','"+textField_2.getText()+"','"+textField_9.getText()+"','"+textField_10.getText()+"','0','')";
									myStmt.executeUpdate(up);
		...
		result2.setBounds(10, 85, 490, 15);
		eAdd.add(result2);
			...
			public void actionPerformed(ActionEvent e) {
				if(!tnametext.getText().equals("")) {
					try {
						...
						Statement myStmt = conn.createStatement();
						ResultSet myRs = myStmt.executeQuery("select * from equipmenttype where typename like '%"+tnametext.getText()+"%'");
						while (myRs.next()) {
			...
			public void actionPerformed(ActionEvent e) {
				if(!tIDtext.getText().equals("")) {
					try {
						model4.setRowCount(0);
						Statement myStmt = conn.createStatement();
						ResultSet myRs = myStmt.executeQuery("select * from equipmenttype where typeID = '"+tIDtext.getText()+"'");
						while (myRs.next()) {
							model4.addRow(new String[]{myRs.getString("typeID"),myRs.getString("typeName")});
						}
					}
