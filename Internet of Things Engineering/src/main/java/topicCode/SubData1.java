...
public class SubData1 implements Runnable{
	public void run() {
		String subTopic = "61_Brightness";     /*esp8266/data*/
...
//        String content = "1111111111";///要发送的指令
        ...
        try {
            ...
            // 建立连接
            System.out.println("Connecting to broker1: " + broker);
